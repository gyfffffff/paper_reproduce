...
for stock in topstocks.index:
    ...
    s_date = datetime.datetime.strptime('20150101', '%Y-%m-%d').date()
    e_date = datetime.datetime.strptime('20230101', '%Y-%m-%d').date()
    validdata = data[['DATES', 'SeqOpenPrice', 'SeqClosePrice',
                                      'SeqHighPrice', 'SeqLowPrice', 'SeqTurnoverVolume']][data["DATES"]>s_date & data['DATES']<'2023-1-1']
    print(validdata)
    break
