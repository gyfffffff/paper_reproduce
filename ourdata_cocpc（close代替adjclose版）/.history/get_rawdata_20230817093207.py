...
volumeconunt_df = pd.Da({'000001.SZ.csv': 83031607.73231708, '000002.SZ.csv': 85833776.00121951,
                                '000004.SZ.csv': 2470245.7021341464}, index=[1,2,3], columns=['stock', 'avg_volume'])
