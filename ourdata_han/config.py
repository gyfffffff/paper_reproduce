...
argparser.add_argument("--pickle_path", type=str,
                       default='data/cbow3639_3071.pkl')
...
argparser.add_argument("--vocab_size", type=int, default=32000)
argparser.add_argument("--word_embed_path", type=str,
                       default='data/cbow.news.100d.txt')
...
argparser.add_argument("--max_date_len", type=int, default=3)  # StockNet
...
argparser.add_argument("--host", type=str,
                       default=socket.getaddrinfo('localhost', 8080))
